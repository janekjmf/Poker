    ...
    public static Collection tests()
    {
        ...
        Object[][] tests = {
                {Arrays.asList(new Karta(Figura.CZWORKA, Kolor.Kier),
                        ...
                        new Karta(Figura.WALET, Kolor.Kier)), Uklad.DWIE_PARY
                },
                {Arrays.asList(new Karta(Figura.CZWORKA, Kolor.Karo),
                        new Karta(Figura.CZWORKA, Kolor.Pik),
                        new Karta(Figura.OSEMKA, Kolor.Kier),
                        new Karta(Figura.AS, Kolor.Trefl),
                        new Karta(Figura.AS, Kolor.Kier)), Uklad.DWIE_PARY
                },
                {Arrays.asList(new Karta(Figura.DWOJKA, Kolor.Kier),
                        new Karta(Figura.DZIESIATKA, Kolor.Karo),
                        new Karta(Figura.SIODEMKA, Kolor.Pik),
                        new Karta(Figura.SIODEMKA, Kolor.Kier),
                        new Karta(Figura.DWOJKA, Kolor.Trefl)), Uklad.DWIE_PARY
                },
                {Arrays.asList(new Karta(Figura.AS, Kolor.Kier),
                        ...
                        new Karta(Figura.SZOSTKA, Kolor.Kier)), Uklad.DWIE_PARY
                },
                {Arrays.asList(new Karta(Figura.AS, Kolor.Pik),
                        ...
                        new Karta(Figura.AS, Kolor.Trefl)), Uklad.DWIE_PARY
                },
        };
