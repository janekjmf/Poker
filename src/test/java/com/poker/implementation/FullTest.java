    ...
    public static Collection tests()
    {
        ...
        Object[][] tests = {
                {Arrays.asList(new Karta(Figura.CZWORKA, Kolor.Kier),
                        ...
                        new Karta(Figura.DAMA, Kolor.Kier)), Uklad.FULL
                },
                {Arrays.asList(new Karta(Figura.PIATKA, Kolor.Karo),
                        ...
                        new Karta(Figura.AS, Kolor.Kier)), Uklad.FULL
                },
                {Arrays.asList(new Karta(Figura.DWOJKA, Kolor.Kier),
                        ...
                        new Karta(Figura.SIODEMKA, Kolor.Trefl)), Uklad.FULL
                },
                {Arrays.asList(new Karta(Figura.DAMA, Kolor.Kier),
                        ...
                        new Karta(Figura.SZOSTKA, Kolor.Kier)), Uklad.FULL
                },
                {Arrays.asList(new Karta(Figura.KROL, Kolor.Kier),
                        new Karta(Figura.KROL, Kolor.Pik),
                        new Karta(Figura.KROL, Kolor.Trefl),
                        new Karta(Figura.WALET, Kolor.Pik),
                        new Karta(Figura.WALET, Kolor.Trefl)), Uklad.FULL
                },
        };
