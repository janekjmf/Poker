...
public class WysokaKartaTest
{
    private ArrayList<Karta> ukladKart;
    private Uklad odpowiedz;
    private static int numerTestu;

    public WysokaKartaTest(List<Karta> ukladKart, Uklad odpowiedz)
    {
        super();
    ...
    public static Collection tests()
    {
        ...
        Object[][] tests = {
                ...
                {Arrays.asList(new Karta(Figura.DAMA, Kolor.Kier),
                        ...
                        new Karta(Figura.SZOSTKA, Kolor.Kier)), Uklad.WYSOKA_KARTA
                },
                {Arrays.asList(new Karta(Figura.DWOJKA, Kolor.Pik),
                        new Karta(Figura.KROL, Kolor.Pik),
                        new Karta(Figura.DAMA, Kolor.Pik),
                        new Karta(Figura.WALET, Kolor.Pik),
                        new Karta(Figura.AS, Kolor.Trefl)), Uklad.WYSOKA_KARTA
                },
        };
